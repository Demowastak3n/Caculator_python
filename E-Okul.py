...
def ort():
    ...
    secim = input("Hangi dersin ortalamasini hesaplamak istiyorsunuz? (MatO, TurkO, FenO, IngO ) = ")
    ...
    if secim == "MatO":
         Mat()
         print(ogrenci["Isim"], Mat_ort, "Aldi")

    elif secim == "TurkO":
        Turk()
        print(ogrenci["Isim"], Turk_ort, "Aldi")

    elif secim == "FenO":
        Fen()
        print(ogrenci["Isim"], Fen_ort, "Aldi")

    elif secim == "IngO":
        Ing()
        print(ogrenci["Isim"], Ing_ort, "Aldi")

    else:
        print(ogrenci["Isim"], Ort, "Aldi")
